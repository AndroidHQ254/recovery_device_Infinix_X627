# Device path
LOCAL_PATH := device/Infinix/X627
...
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,32S1 androidboot.selinux=permissive
BOARD_MKBOOTIMG_ARGS := --base 0x40000000 --ramdisk_offset 0x11b00000 --second_offset 0x40f00000 --tags_offset 0x07880000
